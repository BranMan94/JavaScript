...
La sentencia return finaliza la ejecucion de la funcion, y especifica un valor para ser devuelo a quien llama a la funcion. O lo que es lo mismo, usamos return para finalizar y tambien para poder asignar el resultado a una variable.
...
// Para poder usar esa variable que hasta este momento sacamos de la funcion, pero que no sabemos donde esta (porque esta en limbo de las funciones). Y en esta nueva variable ponemos la invocacion de la funcion.
...
// var nombreQueSaqueDeMiFuncion = prompt("Introduce tu nombre");
// console.log("Gracias por entrar a mi pagina" + )
